...
EXPIRY_SECONDS = 86400 * 30 # Set to 30 seconds for testing
...
def activate_ult_plan(user_id: str) -> bool:
    ...
    # Check if user already has unexpired ULT plan
    plan = user.get("plan", {})
    ...
    if current_credits != "∞":
        try:
            ...
            new_credits = current_credits + ULT_CREDIT_BONUS
        except:
            new_credits = ULT_CREDIT_BONUS
    else:
        new_credits = "∞"
